...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        Funcionario pessoa1 = new Funcionario("Elvis", 23, "4551515561", "09/02/2000", "infermeiro",3300.00,"Medico","Medicina");
        Funcionario pessoa2 = new Funcionario("Carlos", 25, "4551515561", "09/02/2000", "pedreiro",1500.00,"ajudante geral","admin");
        Funcionario pessoa3 = new Funcionario("Anthony", 32, "4551515561", "09/02/2000", "Empresario",12000.00,"","autonomo");
